...
wget -O custom_components/input_number/reproduce_state.py https://raw.githubusercontent.com/home-assistant/home-assistant/dev/homeassistant/components/input_number/reproduce_state.py
